...
<section id="wrapper" class="login-register login-sidebar" style="background-image:url('<?= $this->config->base_url(); ?>assets/images/acctng2.jpg');">
    <div class="login-box card">
        <div class="card-body">
            ...
            ?>
            <form class="form-horizontal form-material" id="loginform" action = "<?= $this->config->base_url(); ?>payroll/login_submit" method = "POST">
                <a class="text-center db">
                    <img src="<?= $this->config->base_url()?>assets/images/icon.png" alt="Home" width = "20%"><br>
                    <img src="<?= $this->config->base_url()?>assets/images/payroll-s.png" alt="Home" width = "70%">
                </a>

                <div class="form-group m-t-40">
                    <div class="col-xs-12">
                        <input class="form-control" type="text" placeholder="Username" name="tf_username" value = "<?= $username; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control" type="password" placeholder="Password" name="tf_password" value = "<?= $password; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-12">
                ...
                <div class="form-group text-center m-t-20">
                    <div class="col-xs-12">
                        <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit" style = "background-color: #65aad3; border-color: #65aad3; color: white">Log In</button>
                    </div>
                </div>
                <div class="form-group m-b-0">
                    <div class="col-sm-12 text-center">
                        <p>2017 &copy; System Extraordinary Igniters | B31</p>
                    </div>
                </div>
            </form>
        </div>
