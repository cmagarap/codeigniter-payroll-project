...
<div class="row">
    <div class="col-md-4 col-xs-12">
        <div class="white-box" style = "background-color: #2f313e">
            <div class="user-bg">
                <img width="100%" alt="user" src="<?= $this->config->base_url(); ?>uploads/<?= $account->s_admin_image_path ?>">
            </div>
            <div class="user-btm-box">
                <h4 class = "text-white">User: <b style = "color: #65aad3"><?= $account->s_admin_username ?></b></h4>
                <hr>
    ...
    <div class="col-md-8 col-xs-12">
        <div class="white-box">
            <form class="form-horizontal form-material" method = "POST" action = "<?= $this->config->base_url() ?>profile/update_profile" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" placeholder="Type username here..." class="form-control form-control-line" name = "tf_s_username" value = "<?= $account->s_admin_username ?>"></div>
                </div>
                <div class="form-group">
                    <label class="col-md-12">Last Name <font color = "red">*</font></label>
                    <div class="col-md-12">
                        <input type="text" placeholder="Type your last name here..." class="form-control form-control-line" name = "tf_s_lastname" value = "<?= $account->s_admin_lastname ?>"> </div>
                </div>
                <div class="form-group">
                    <label class="col-md-12">First Name <font color = "red">*</font></label>
                    <div class="col-md-12">
                        <input type="text" placeholder="Type your first name here..." class="form-control form-control-line" name = "tf_s_firstname" value = "<?= $account->s_admin_firstname ?>"> </div>
                </div>
                <div class="form-group">
                    <label for="example-email" class="col-md-12">Email <font color = "red">*</font></label>
                    <div class="col-md-12">
                        <input type="text" placeholder="Type your email address here..." class="form-control form-control-line" name = "tf_s_email" value = "<?= $account->s_admin_email ?>"> </div>
                </div>
                <div class="form-group">
                    <label class="col-md-12">Phone No. <font color = "red">*</font></label>
                    <div class="col-md-12">
                        <input type="text" placeholder="09xxxxxxxxx" class="form-control form-control-line" name = "tf_s_phone_no" value = "<?= $account->s_admin_contact ?>">
                    </div>
                </div>
                <div class="form-group">
